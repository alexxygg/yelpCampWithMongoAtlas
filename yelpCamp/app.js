...
//Atlas DataBase  for MONGO, real, don't use as playground!
//Continue at mongoose.connect in this file
...
//Instead of using local storage, we use the mongo store
//A collection is created in our Mongo Database , a session object
//for every browser/user, cookies and data removed after 14 days
//this default value can be changed
const store = new MongoDBStore({
  // url: "mongodb://localhost:27017/yelp-camp",
  //For live production mongo db, not local
  url: dbUrl,
  secret: "asecret",
  //Prevents unnecessary updates if no changes to session
  //Time in seconds
  touchAfter: 24 * 60 * 60,
});
...
const sessionConfig = {
  //HERE WE PASS IN store, to use Mongo as storage
  store,
  name: "session",
